...
export default function Mission() {
  return (
    <section className="relative bg-[#ffffff] w-full min-h-auto rounded-t-3xl -mt-7 z-30 px-8 md:px-16 2xl:px-18 py-16 overflow-hidden">
      <div className="grid grid-cols-12 gap-4 md:gap-0">
        <div className="col-span-12 md:col-span-4 mb-12 md:mb-0">
          <h2 className="text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl text-[#104179] uppercase font-semibold">
            Inside GLUNS
          </h2>
        </div>
        <div className="col-span-12 md:col-span-8 flex flex-col md:justify-end md:items-end gap-8 text-[#104179]">
          ...
          <div className="mission flex flex-col md:flex-row md:gap-16 md:justify-end">
            ...
            <h3 className="text-3xl 2xl:text-4xl uppercase">Our Mission</h3>
          ...
          <div className="vision flex flex-col md:flex-row md:gap-16 md:justify-end">
            ...
            <h3 className="text-3xl 2xl:text-4xl uppercase">Our Vision</h3>
