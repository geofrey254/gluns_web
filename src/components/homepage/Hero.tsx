...
export default function Hero() {
  return (
    <section className="relative bg-[#051220] md:min-h-[60vh] lg:min-h-screen flex px-6 md:px-8 items-center overflow-hidden">
      {/* gradient overlay */}
      ...
      <div className="relative z-10 w-full md:max-w-2xl lg:max-w-3xl py-20">
        ...
        <div className="grid grid-cols-3 gap-6 md:gap-12 pt-8 max-w-2xl">
          <div className="space-y-2">
            ...
            <div className="text-sm md:text-base text-white/70">Delegates</div>
          </div>
          <div className="space-y-2">
            <div className="text-4xl md:text-5xl font-bold text-white">50+</div>
            <div className="text-sm md:text-base text-white/70">Schools</div>
          </div>
          <div className="space-y-2">
            <div className="text-4xl md:text-5xl font-bold text-white">20+</div>
            <div className="text-sm md:text-base text-white/70">Committees</div>
          </div>
        </div>
        ...
        <div className='flex items-center gap-8'>
          ...
          <Link
            ...
            <span className="relative z-10 text-lg md:text-xl">Learn More</span>
