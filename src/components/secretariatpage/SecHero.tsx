      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 border-2 rounded-full" style={{ borderColor: '#104179' }}>
            ...
            {/* Main Heading */}
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1]" style={{ color: '#104179' }}>
              Leadership
              That Drives
              <br />
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-2xl">
              The GLUNS Secretariat coordinates conference planning, operations, and delegate experience, ensuring a rigorous, inclusive, and impactful platform for emerging global leaders.
            </p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white p-6 shadow-2xl max-w-xs rounded-xl">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 flex items-center justify-center shrink-0" style={{ backgroundColor: '#104179' }}>
                    <span className="text-white font-black text-xl">★</span>
                  </div>
                  <div>
                    <div className="text-2xl font-black mb-1" style={{ color: '#104179' }}>2025</div>
